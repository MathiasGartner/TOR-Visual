package TORVisual.Settings;

public class SettingsVisual {

    public static final int LoadDataEveryNthFrame = 60;
    public static final int StoreLastNDiceResults_Default = 10;

    public static final int ResultsNeededForOneCoordinate = 11;

    public static final String DiceResultEventSource = "JMAF2022";
